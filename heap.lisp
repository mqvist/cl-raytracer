...
(defun make-prioq (pred &optional (initial-contents nil))
  (create-heap pred :initial-contents initial-contents))

(defun prioq-insert (prioq item)
  (heap-insert prioq item))

(defun prioq-pop (prioq)
  (heap-remove prioq))
